...
VALUES
    ...
    ('SFA9907L', 'U7700765432V', 'white',  2010, 1),
    ...
    ('SXY9034C', 'OBU8931XZP9',  'white',  2019, 1),
    ('SFG6722T', 'OBU1198RTK4',  'blue',   2016, 1),
    ('SLP1149M', 'OBU6635BDS2',  'grey',   2018, 1),
    ('SJA9083H', 'OBU2457QAW8',  'red',    2020, 1),
    ('SMU2206U', 'OBU3389PQL7',  'black',  2017, 1),
    ('SNN5548R', 'OBU5512DFY1',  'silver', 2015, 1),
    ('SCE8884Y', 'OBU7834KTV0',  'white',  2014, 1),
    ('SGF2123A', 'OBU9086LWM3',  'blue',   2013, 1),
    ('SLE6782Z', 'OBU4325NRS6',  'grey',   2021, 1),
    ('SBA4435D', 'OBU5548QGC1',  'red',    2022, 1),
    ('SKC9017J', 'OBU6719VAD5',  'silver', 2018, 1),
    ('SPG5519L', 'OBU3284MBQ4',  'white',  2023, 1),
    ('SJL7758P', 'OBU9632HZN7',  'black',  2020, 1),
    ('SBF6230S', 'OBU2834RGX2',  'blue',   2017, 1),
    ('SDE1106T', 'OBU5743QAY9',  'grey',   2019, 1),
    ('SMF4477C', 'OBU4960NBW5',  'red',    2015, 1),
    ('SJK7709G', 'OBU8074YPL6',  'white',  2014, 1),
    ('SGM4482K', 'OBU1863TKZ2',  'black',  2016, 1),
    ('SJB9924E', 'OBU6395CJF1',  'silver', 2021, 1),
    ('SHN6691A', 'OBU2807XLE8',  'blue',   2022, 1),
    ('SKZ5540M', 'OBU8210FJH4',  'grey',   2023, 1),
    ('SMD7752R', 'OBU9045GRA3',  'white',  2018, 1),
    ('SFF9008U', 'OBU1279KQB0',  'black',  2020, 1),
    ('SBA2146B', 'OBU3921VNP5',  'silver', 2017, 1),
    ('SNP6755P', 'OBU5740BHW9',  'red',    2019, 1);
